    ...
    <div className="card">
      ...
      <div className="space-y-3">
        {loading ? (
          ...
          <p className="text-gray-400 text-sm">{t('tourGuide.noGuides')}</p>
        ) : (
...
function TourGuideCard({
  ...
  return (
    <div className="bg-gray-700 rounded p-4 space-y-3">
          ...
          {!editMode ? (
            <div>
              <div className="flex items-center gap-2">
                ...
                {guide.code && (
                  <span className="px-2 py-0.5 bg-teal-500 bg-opacity-20 border border-teal-500 rounded text-teal-400 text-xs">
                    {guide.code}
                  </span>
                )}
              </div>
      ...
      {!editMode && !hasSeatPlan && (
        <p className="text-xs text-gray-500 pt-2 border-t border-gray-600">
