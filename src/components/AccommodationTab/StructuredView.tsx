                    ...
                    >
                      <div className="flex items-start justify-between mb-3">
                        <div className="flex-1">
                          <h4 className="text-slate-900 font-semibold">{accommodation.name}</h4>
                          {accommodation.code && (
                            <p className="text-xs text-slate-500 mt-1">Code: {accommodation.code}</p>
                          )}
                        </div>
                      ...
                      <div className="space-y-2">
                        {accommodation.room_type && (
                          <div className="flex items-center justify-between text-sm">
                            <span className="text-slate-500">{t('fields.roomType')}:</span>
                            <span className="text-slate-900">{t(`roomTypes.${accommodation.room_type}`)}</span>
                          </div>
                        )}
                        ...
                        {accommodation.meal_plan && (
                          <div className="flex items-center justify-between text-sm">
                            ...
                            <span className="text-slate-900">{t(`mealPlans.${accommodation.meal_plan}`)}</span>
                          </div>
                        )}

                        {accommodation.nights && (
                          <div className="flex items-center justify-between text-sm">
                            <span className="text-slate-500">{t('fields.nights')}:</span>
                            <span className="text-slate-900">{accommodation.nights}</span>
                          </div>
                        )}
